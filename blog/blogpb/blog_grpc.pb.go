...
type BlogServiceClient interface {
	CreateBlog(ctx context.Context, in *CreateBlogRequest, opts ...grpc.CallOption) (*CreteBlogResponse, error)
...
func (c *blogServiceClient) CreateBlog(ctx context.Context, in *CreateBlogRequest, opts ...grpc.CallOption) (*CreteBlogResponse, error) {
	out := new(CreteBlogResponse)
...
type BlogServiceServer interface {
	CreateBlog(context.Context, *CreateBlogRequest) (*CreteBlogResponse, error)
...
func (UnimplementedBlogServiceServer) CreateBlog(context.Context, *CreateBlogRequest) (*CreteBlogResponse, error) {
